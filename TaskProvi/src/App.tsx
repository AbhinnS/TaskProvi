      ...
      <div className='w-full h-lvh bg-[#A6C9FF] flex items-center justify-center'>
        <div className='w-[95%] h-[90%] bg-white rounded-2xl shadow-lg flex'>
          ...
          <div className='w-full md:w-[30%] h-full'>
            {!open ? <h1 className='text-black font-bold text-[23px] pl-7 pt-8 md:pt-[50%] md:text-[36px] font-Nunito'>Login to your Account</h1> :  <h1 className='text-black font-bold text-[23px] pl-7 pt-8 md:pt-[25%] md:text-[36px] font-Nunito'>Signin to your Account</h1> }
            ...
            <form className='block mt-7 space-y-5'>
              { !open ? <><label className='text-black ml-7'>Email</label><input type="text" className="text-black border border-gray-400 w-[85%] h-10 ml-7 mt-2 px-3 rounded-md font-nunito" /></> : <><label className='text-black ml-7'>First Name:</label><input type="text" className="text-black border border-gray-400 w-[85%] h-10 ml-7 mt-2 px-3 rounded-md font-nunito" /></>}              
              { !open ? "" : <><label className='text-black ml-7'>Last Name:</label><input type="text" className="text-black border border-gray-400 w-[85%] h-10 ml-7 mt-2 px-3 rounded-md font-nunito" /></>}              
              { !open ? "" : <><label className='text-black ml-7'>Email:</label><input type="text" className="text-black border border-gray-400 w-[85%] h-10 ml-7 mt-2 px-3 rounded-md font-nunito" /></>}              
